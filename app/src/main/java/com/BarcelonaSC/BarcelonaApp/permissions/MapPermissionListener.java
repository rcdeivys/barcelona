...
/**
 * Created by Leonardojpr on 3/23/18.
 */

public class MapPermissionListener implements MultiplePermissionsListener {

    MapActivity activity;

    public MapPermissionListener(MapActivity activity) {
