package com.millonarios.MillonariosFC.ui.chat.friendselection.adapter;
...
public class FriendSelectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public FriendSelectionAdapter(List<Amigos> friendsList, Context mContext) {
    ...
    public interface OnItemClickListener {
        void onClickFriend(Amigos friend);
    }
}
